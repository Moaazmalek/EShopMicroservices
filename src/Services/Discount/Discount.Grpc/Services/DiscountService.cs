...
namespace Discount.Grpc.Services
{
        ...
        ILogger<DiscountService> logger):DiscountProtoService.DiscountProtoServiceBase
    {
        ...
        public override async Task<CouponModel> UpdateDiscount(UpdateDiscountRequest request, ServerCallContext context)
        {
            ...
            var updatedModel = coupon.Adapt<CouponModel>();
            return updatedModel;
        ...
        public override async Task<DeleteDiscountResponse> DeleteDiscount(DeleteDiscountRequest request, ServerCallContext context)
        {
            ...
            var coupon = await dbContext.Coupons.FirstOrDefaultAsync(x => x.ProductName == request.ProductName);
            if (coupon is  null) throw new RpcException(new Status(StatusCode.InvalidArgument, $"Discount with ProductName={request.ProductName} is not found."));
